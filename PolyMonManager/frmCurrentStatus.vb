...
#Region "Private Methods"
	...
	Private Sub LoadMonitorData(ByVal MonitorID As Integer)
		...
		If Metadata.Enabled Then
			...
			lblEventDT.Text = Format(CurrStatus.CurrentStatus.EventDate, "MMM dd, yyyy HH:mm:ss")
			...
			Me.lblDetails_Started.Text = Format(CurrStatus.CurrentStatus.StatusStartDT, "MMM dd, yyyy HH:mm:ss")
			Me.lblDetails_Ended.Text = Format(CurrStatus.CurrentStatus.StatusEndDT, "MMM dd, yyyy HH:mm:ss")
